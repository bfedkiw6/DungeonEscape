...
/**
 * This shader is a copy of the orignal phong_frag.glsl in case you have modified that shader.
 *
 * Skinned and static meshes can use the same fragment shader if they have the same out values.
 * You can also modify skinnded_vert.glsl to match any changes you made to phong shaders, and bind
 * both shader programs to the same fragment shader.
 */
